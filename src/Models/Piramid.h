...
namespace PIRAMID {
    ...
    float verticesNormal[] = {
        -0.5,0,-0.5,0, 0.57735, -0.816497,
        0.5,0.0,-0.5,0, 0.57735, -0.816497,
        0.0,SQRT2/2.0,0.0,0, 0.57735, -0.816497,

        0.5,0.0,-0.5,0.816497, 0.57735, 0,
        0.5,0.0,0.5,0.816497, 0.57735, 0,
        0.0,SQRT2/2.0,0.0,0.816497, 0.57735, 0,
...
Piramid::Piramid(){
    Piramid(glm::vec3(0.0f,0.0f,0.0f));
}
